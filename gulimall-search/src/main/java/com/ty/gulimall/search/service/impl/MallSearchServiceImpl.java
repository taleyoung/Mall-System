...
import com.ty.gulimall.search.feign.ProductFeignService;
import com.ty.gulimall.search.service.MallSearchService;
import com.ty.gulimall.search.vo.AttrResponseVo;
import com.ty.gulimall.search.vo.BrandVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    public SearchResult search(SearchParam Param) {
        ...
        try {
            // 2.执行检索请求
            SearchResponse response = restHighLevelClient.search(searchRequest, GulimallESConfig.COMMON_OPTIONS);
